PImage belakang, menuBackground, character, uang, bomb;
...
void setup() {
  smooth();
  size(500, 680);
  belakang = loadImage("belakang.jpg");
  menuBackground = loadImage("latar.png");
  character = loadImage("hog.png");
  uang = loadImage("uang.png");
  bomb = loadImage("bomb.png");
  menuFont = loadFont("ArialMT-48.vlw");
  exitFont = loadFont("Harrington-48.vlw");
...
void menu() {
  ...
  if (dist(mouseX, mouseY, 240, 225)<35) {
    fill(102, 178, 255);
    text("Play", 190, 240);
    if (mousePressed) {
      panels = 6;
...
void level() {
  ...
  switch(levels) {
    ...
    textSize(25);
    String infoLevel1 = "Gerakkan karakter dengan mouse Anda. tangkap apel merah, hindari bom hitam.";
    ...
    text("Level " + levels, 160, 240);
    textSize(25);
    String infoLevel2 = "Tangkap SEMUA apel merah. Jika Anda gagal, Level Anda akan diturunkan ke level 1.";
    ...
    text("Level " + levels, 160, 240);
    textSize(25);
    String infoLevel3 = "Hindari Bom. Jika Anda gagal, Level Anda akan diturunkan ke level 1.";
    ...
    text("Level " + levels, 160, 240);
    textSize(25);
    String infoLevel4 = "Hindari Bom. Tangkap apel merah.";
    ...
    text("Level " + levels, 160, 240);
    textSize(25);
    String infoLevel5 = "Hindari Bom. Tangkap SEMUA apel merah. Jika Anda gagal, Level Anda akan diturunkan ke level 1.";
    ...
    text("Fail", 160, 240);
    textSize(25);
    String infoLevel6 = "Anda telah gagal. Level Anda telah diturunkan menjadi 1.";
